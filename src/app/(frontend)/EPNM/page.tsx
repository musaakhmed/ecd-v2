          ...
          >
            ...
            >
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                L&apos;Espace Public Numérique Mobile (EPNM) est un service innovant qui se
                déplace directement sur votre lieu de travail ou dans votre quartier pour proposer
                des formations numériques adaptées à vos besoins.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Nous apportons les équipements nécessaires et offrons un accompagnement
                personnalisé pour vous initier ou vous perfectionner dans l&apos;utilisation des
                outils numériques, que ce soit pour votre vie professionnelle ou personnelle.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.p
              ...
              className="text-center text-gray-600 mb-12 max-w-2xl mx-auto"
            >
              Nos formations s&apos;adressent à tous ceux qui souhaitent améliorer leurs
