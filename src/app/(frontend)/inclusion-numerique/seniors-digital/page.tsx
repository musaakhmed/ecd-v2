        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="mb-8">
              <DarkTextCard variant="solid" title="Objectif général" raw>
            ...
            <motion.div variants={fadeInUp} className="mb-8">
              <DarkTextCard variant="gradient-secondary" title="Objectifs spécifiques" raw>
            ...
            <motion.div variants={fadeInUp} className="mb-8">
              <DarkTextCard variant="solid" title="Une approche de proximité, centrée sur les besoins" raw>
                <p className="leading-relaxed mb-6 text-inherit">
            ...
            <motion.div variants={fadeInUp}>
              <DarkTextCard variant="gradient-primary" title="Impact et finalité" raw>
                <p className="leading-relaxed mb-6 text-inherit">
