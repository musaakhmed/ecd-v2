      ...
      <section className="relative text-white py-20 md:py-28 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            >
              Aujourd&apos;hui, de nombreux services du quotidien sont devenus numériques : payer une
              facture en ligne, télécharger un document administratif (comme un certificat de bonne
              vie et mœurs), effectuer des achats sur Internet, utiliser l&apos;e-banking ou encore
              prendre un rendez-vous via une plateforme en ligne.
            </motion.p>
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-xl text-white/90 leading-relaxed mb-4"
            >
              Pour une partie importante de la population — et particulièrement les seniors — ces
              démarches restent complexes. Elles peuvent générer du stress, une perte de confiance et
              renforcer un sentiment d&apos;isolement ou d&apos;exclusion.
            </motion.p>
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-xl text-white/90 leading-relaxed"
            >
              Dans ce contexte, Espace Cultures & Développement (ECD asbl) propose un accompagnement
              numérique adapté, concret et accessible, afin d&apos;aider les seniors à utiliser les
              outils numériques en toute sécurité, à leur rythme et dans un cadre bienveillant.
            </motion.p>
          </motion.div>
        </div>
      </section>
