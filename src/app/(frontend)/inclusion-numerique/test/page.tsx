...
const Page = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        'Apprenez à utiliser votre smartphone : applications, messagerie, photos, navigation.',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-primary-50">
      ...
      <section className="relative bg-gradient-to-r from-primary-600 to-secondary-600 text-white py-20 md:py-28 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('/assets/hero/seniors-transition-numerique.jpg')] bg-cover bg-center mix-blend-overlay opacity-20"></div>
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              Un service mobile qui vient à vous pour réduire la fracture numérique et rendre
              l&apos;accès aux outils digitaux accessible à tous.
            </motion.p>
          ...
          >
            ...
            >
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                L&apos;Espace Public Numérique Mobile (EPNM) est un service innovant qui se déplace
                directement sur votre lieu de travail ou dans votre quartier pour proposer des
                formations numériques adaptées à vos besoins.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Nous apportons les équipements nécessaires et offrons un accompagnement personnalisé
                pour vous initier ou vous perfectionner dans l&apos;utilisation des outils
                numériques, que ce soit pour votre vie professionnelle ou personnelle.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              Des formations pratiques et accessibles pour maîtriser les outils numériques
              essentiels
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.p
              ...
              className="text-center text-gray-600 mb-12 max-w-2xl mx-auto"
            >
              Nos formations s&apos;adressent à tous ceux qui souhaitent améliorer leurs compétences
              numériques
            </motion.p>
                ...
                {[
                  {
                    ...
                    description:
                      'Contactez-nous pour discuter de vos besoins et de vos objectifs de formation.',
                  },
                  {
                    step: '02',
                    title: 'Planification',
                    description:
                      'Nous organisons une intervention sur votre site avec les équipements nécessaires.',
                  },
                  {
                    step: '03',
                    title: 'Formation',
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-xl text-white/90 mb-8 leading-relaxed">
              Contactez-nous pour organiser une intervention sur votre site ou dans votre quartier.
            </motion.p>
            <motion.a
              variants={fadeInUp}
              href="/contact"
