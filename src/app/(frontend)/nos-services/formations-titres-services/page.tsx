        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <motion.p
              ...
              className="text-lg text-gray-700 dark:text-gray-200 leading-relaxed mb-8 text-center"
            >
              Ces modules améliorent les conditions de travail, réduisent la pénibilité et renforcent
              la sécurité, particulièrement pour les métiers d&apos;intervention à domicile ou de proximité.
            </motion.p>
            <motion.div
              variants={fadeInUp}
