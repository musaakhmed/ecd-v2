          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
            ...
            >
              ...
              <motion.form
                ...
                className="space-y-6 bg-white rounded-2xl shadow-lg p-8 border border-primary-100"
              >
                <div>
                  <label
                    htmlFor="name"
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="epnm">Espace Public Numérique Mobile (EPNM)</option>
                    <option value="edd">École de Devoirs (EDD)</option>
                    <option value="titres-services">Formations Titres-Services</option>
                ...
                <button
                  ...
                  className="w-full bg-primary-600 text-white font-semibold px-8 py-4 rounded-lg hover:bg-primary-700 transition-colors duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
          ...
          >
            ...
            >
              <div className="aspect-video bg-gray-200 relative">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2519.5!2d4.35!3d50.85!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTDCsDUxJzAwLjAiTiA0wrAyMScwMC4wIkU!5e0!3m2!1sfr!2sbe!4v1234567890"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="p-6 bg-primary-50">
                ...
                <div className="flex justify-center mt-4">
                  <a
                    href="https://maps.google.com/?q=Rue+du+Gouvernement+Provisoire+34A,+1000+Bruxelles"
                    target="_blank"
