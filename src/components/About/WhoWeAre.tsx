...
const WhoWeAre = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-8">
      <div
        id="who-we-are"
        className="bg-primary-800 rounded-xl md:rounded-2xl min-h-[18vh] md:min-h-[19vh] text-base md:text-lg xl:text-xl text-primary-50 flex flex-col md:flex-row justify-center gap-4 md:gap-5 overflow-hidden"
      >
        {/* Text block */}
