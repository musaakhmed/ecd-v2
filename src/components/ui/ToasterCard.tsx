export default function ToasterCard() {
  return (
    <div className="relative w-[88vw] max-w-[1520px] aspect-[1.72/1]">
      <div className="absolute inset-0 translate-x-[2.5%] translate-y-[3.5%] rotate-[0.4deg] rounded-[58px] bg-white" />

      <div className="absolute inset-0 -rotate-[3.2deg] rounded-[58px] bg-[#e3e3e3]">
