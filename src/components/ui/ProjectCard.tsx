  ...
  return (
    ...
    >
      <Link href={project.link} className="block h-full">
        <div className="bg-gradient-to-br from-azure-500 to-azure-600 rounded-xl overflow-hidden border border-azure-600 shadow-md hover:shadow-xl transition-all duration-300 h-full flex flex-col relative group-hover:border-azure-500 min-h-[380px] md:min-h-[420px]">
          <div className="relative h-40 md:h-44 flex-shrink-0 overflow-hidden rounded-t-xl">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-azure-900/90 via-azure-800/45 to-transparent" />
          </div>
          <div className="p-5 md:p-6 flex flex-col flex-1 min-h-0 relative">
            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-white/25 to-transparent rounded-full -mr-12 -mt-12" />
            <div className="relative z-10 flex flex-col flex-1 min-h-0">
              <h3 className="text-xl font-semibold text-white mb-2 flex-shrink-0">
                {project.title}
              </h3>
              <p className="text-white/90 text-sm md:text-base leading-relaxed flex-1 min-h-0 line-clamp-3 mb-4">
                {project.description}
              </p>
