  ...
  projetPedagogique: {
    ...
    objectifs: [
      ...
      },
      {
        ...
        description:
          "en proposant un encadrement bienveillant, sécurisant et stimulant ;",
      },
      {
      ...
      },
      {
        ...
        description:
          "indispensables au parcours scolaire et au développement personnel ;",
      },
      {
        title: "Un climat de convivialité et de confiance",
        description:
          "propice à l'apprentissage et à l'expression de chacun ;",
      },
      {
