...
export const maintenanceSections: ServiceSection[] = [
  ...
  },
  {
    ...
    items: ['Mises à jour système et logiciels', 'Vérification matérielle (disques, ventilation…)', 'Nettoyage interne et optimisation'],
    conclusion: {
      label: 'Objectif :',
  ...
  },
  {
    ...
    items: ['Antivirus et anti-malwares professionnels', "Analyse et suppression d'infections", 'Conseils pour une sécurité durable'],
    conclusion: {
